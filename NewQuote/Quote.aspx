<%@ Page Title="New Quote - Quote" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Quote.aspx.cs" Inherits="NewQuote_Quote" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <fieldset>
            <legend>
                <asp:Label ID="PolicyDetailsLabel" runat="server" Text="Details"></asp:Label>
            </legend>
            <label for="PolicyQuotationLabel">Your Calculated Quote:</label>
        ...
        <asp:Button ID="Agree" runat="server" Text="Agree" CssClass="button" OnClick="Agree_Click" />
        <asp:Button ID="Decline" runat="server" Text="Decline" CssClass="button" OnClick="Decline_Click" />
    </div>
</asp:Content>
